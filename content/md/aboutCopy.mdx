...
After the untimely death of Flash, I started a company building iPhone apps that allowed users to find digital content in the real world. After 18 months of graft, we’d produced two iOS apps. The first for a record label, took users on a treasure hunt along East London’s canals, unlocking video of live acoustic performances by visiting the outdoor locations where they had been recorded. The second was a play commissioned for the Brighton Festival, unlocked as the user walked around the city with their route defined by the play’s narrative.

Although both were quietly successful, they were far from profitable and I decided to switch direction. I taught myself Rails and started contracting, working on a wide variety of projects, sometimes designing the UI as well as handling the build. Ruby helped consolidate the more disciplined programming style I’d learned building iOS apps, and although I’d often incorporate a little JavaScript to make things more interactive, I was mostly focused on the back-end.

When React came along I was immediately hooked, and I pivoted to concentrating on the front-end again. React and the wider JavaScript ecosystem allowed me to combine my experience of UX, design and styling with programming in a way I found interesting and very rewarding. I spent over two years contracting for an American company building a platform to facilitate drug trials, joining early and working on prototyping and building the front-end, and ultimately seeing the success of the first public release.

For the last six years I worked for a Digital Health startup which used CBTI (Cognitive Behavioural Therapy for Insomnia) to treat sleep disorders through a web-app used by a team of ‘sleep coaches’. During my time there the company scaled up from five people to almost 100, and by the time I left we had treated over 100,000 patients, with the rate of new patients increasing 100 fold. By the time I left it was the UK’s most successful digital sleep treatment app.
...
I love the outdoors, especially long-distance hiking and camping in wild country. I’ve walked around the Annapurna and Manaslu massifs in the Nepalese Himalaya, walked almost 1000km along the Turkish coast, and this year I completed the Pennine Way from South to North in fifteen days and walked the ultra trail across Madeira.
...
Learning is a constant in my life, and I read/listen to a lot of books, particularly non-fiction with an emphasis on history and technology. I also regularly spend my spare time picking up new tech or taking courses on things that I’m interested in. At the moment I’m focused on machine learning and Web 3, particularly Bitcoin.
