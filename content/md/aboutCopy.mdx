...
For the last six years I worked for a Digital Health startup which used CBTI (Cognitive Behavioural Therapy for Insomnia) to treat sleep disorders through a web-app and a team of ‘sleep coaches’. During my time there the company scaled up from five people to almost 100, and by the time I left we had treated over 100,000 patients, with the rate of new patients increasing 100 fold. By the time I left it was the UK’s most successful digital sleep treatment app.
